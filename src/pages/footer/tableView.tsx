...
const TableList = () => {
  ...
  const fetchData = useCallback(
    async (page: number, pageSize: number) => {
      ...
      try {
        const res = await fetchFootersReq(page, pageSize);
