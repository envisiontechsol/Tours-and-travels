...
const TableView = () => {
  ...
  const [data, setData] = useState<UserResWithPermissionType[]>([]);
  ...
  const fetchData = useCallback(
    async (page: number, pageSize: number) => {
      ...
      try {
        const res = await fetchUsersReq(page, pageSize);
