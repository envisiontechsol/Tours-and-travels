...
const VehicleTableList = () => {
  ...
  const fetchData = useCallback(
    async (page: number, pageSize: number) => {
      ...
      try {
        const res = await fetchVehicleReq(page, pageSize);
