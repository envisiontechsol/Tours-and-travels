...
const TableList = () => {
  ...
  const fetchData = useCallback(
    async (page: number, pageSize: number) => {
      ...
      try {
        const res = await fetchTourPackagesReq(page, pageSize);
