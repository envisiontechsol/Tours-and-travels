...
import { fetchUserItineraries } from "../../services/api/user-itinerary/user-itinerary-api";
...
const TableView = () => {
  ...
  const [data, setData] = useState<UserItinerayListResType[]>([]);
  ...
  const fetchData = useCallback(
    async (page: number, pageSize: number) => {
      ...
      setError(null);
      try {
        const res = await fetchUserItineraries(page, pageSize);
        setData(res?.data);
        setPagination({
